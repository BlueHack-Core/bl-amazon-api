...
class PostDictionaryProductsAttrsResponse(Model):
    ...
    def __init__(self, message: str=None, data: str=None):  # noqa: E501
        ...
        :type message: str
        :param data: The data of this PostDictionaryProductsAttrsResponse.  # noqa: E501
        :type data: str
        """
        self.swagger_types = {
            'message': str,
    ...
    @property
    def data(self) -> str:
        """Gets the data of this PostDictionaryProductsAttrsResponse.


        :return: The data of this PostDictionaryProductsAttrsResponse.
        :rtype: str
        """
        return self._data
    ...
    def data(self, data: str):
        """Sets the data of this PostDictionaryProductsAttrsResponse.


        :param data: The data of this PostDictionaryProductsAttrsResponse.
        :type data: str
        """
